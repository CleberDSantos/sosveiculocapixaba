...
declare namespace L {
    ...
    export interface Control extends IControl {
        ...
        update(): Function;
        update(properties: any): Function;
...
declare namespace L {
    ...
    export interface LatLngStatic {
        ...
        new (latitude: any, longitude: any): LatLng;
        /**
          * Creates an object representing a geographical point with the given latitude
          * and longitude.
          */
...
declare namespace L {
    ...
    /**
      *Creates a Bounds object defined by the points it contains.
     */
    function point(points: Point[], round?: boolean): Point;
...
declare namespace L {
    ...
    export interface PolylineStatic extends ClassStatic {
        ...
        fromEncoded(encodedContent: string): Array<L.LatLng>;
    }
...
declare namespace L {
    ...
    namespace Util {
        ...
        /**
          * Schedules fn to be executed when the browser repaints. When immediate is set, fn is called immediately
          * if the browser doesn't have native support for requestAnimationFrame, otherwise it's delayed.
          * Returns an id that can be used to cancel the request.
          */
        export function requestAnimFrame(fn: Function, context?: any, immediate?: boolean, element?: HTMLElement): number;

...
declare module google {
    ...
    module visualization {
        ...
        export interface IChartDraw {
            draw(dataTable: DataTable, options?: any): void;
            draw(dataView: DataView, optioins?: any): void;
        ...
        export class ScatterChart extends CoreChartBase implements IChartDraw {
        ...
        export class ColumnChart extends CoreChartBase implements IChartDraw {
        ...
        export class LineChart extends CoreChartBase implements IChartDraw {
        ...
        export class BarChart extends CoreChartBase implements IChartDraw {
        ...
        export class Histogram extends CoreChartBase implements IChartDraw {
        ...
        export class AreaChart extends CoreChartBase implements IChartDraw {
        ...
        export class AnnotationChart extends CoreChartBase implements IChartDraw
		{
        ...
        // https://google-developers.appspot.com/chart/interactive/docs/gallery/areachart
        export class SteppedAreaChart extends CoreChartBase implements IChartDraw {
        ...
        export class PieChart extends CoreChartBase implements IChartDraw {
        ...
        // https://google-developers.appspot.com/chart/interactive/docs/gallery/scatterchart
        export class BubbleChart extends CoreChartBase implements IChartDraw {
        ...
        export class TreeMap extends ChartBase implements IChartDraw {
        ...
        export class Table extends ChartBase implements IChartDraw {
        ...
        export class Timeline implements IChartDraw {
            constructor(element: Element);
        ...
        export class CandlestickChart extends CoreChartBase implements IChartDraw {

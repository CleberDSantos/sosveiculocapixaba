...
declare module d3 {
    ...
    interface Selection<Datum> {
         ...
         */
        style(name: string): string;
        style(name: string, p2: (d: any) => d3.Rgb);
         ...
         */
        on(type: string): (datum: Datum, index: number, outerIndex: number) => any;
        on(type: string, p2: (datum: any, index: number, outerIndex: number) => any);
    ...
    export function median(value:any): any;
    ...
    module svg {
        ...
        interface Axis {
            ...
            tickSize(): number;
            tickSize(p1: number, p2: number, p3: number);

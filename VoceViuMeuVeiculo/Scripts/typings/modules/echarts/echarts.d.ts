...
declare namespace echarts {
    function init(dom: any | HTMLCanvasElement, theme?: Object | string, opts?: {
        devicePixelRatio?: number;
        renderer?: string;
    }): ECharts;

    function init(dom: any): any;

    function init(dom: any, obj: any): any;

    //init(dom, { renderer: i.renderer || "canvas", devicePixelRatio: i.devicePixelRatio })

    function connect(group: string | Array<string>): void;

    function disConnect(group: string): void;

    function dispose(target: ECharts | HTMLDivElement | HTMLCanvasElement | any): void;
